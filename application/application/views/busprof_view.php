...
<div id="wrapper">
		...
		<div class=ColumnInfo>
			<?php
                    echo form_open('Business/validProf'); ?>
			...
			<div style="margin-top: 30px" class="row">
			  <div style="margin-right: 100px;font-size: 12px" class="column">
			  	...
			  	<br><br>
				<i class='fa fa-book'> </i>&nbsp <?php echo "".$item->Business_ID.""?>
				<br><br>
	    ...
	    <div style="height: 575px;" class="container">
		    ...
		    <div class="row">
		    	...
		    	<div style="padding: 0px" class="column">
				    <label for="fname">Nombres y Apellido</label>  <br>
				    ...
				    <label for="Responible">Nombre de la Fundacion	</label> <br>
				   
				    <?php $data_lname = array(
									                        'name' => 'ifname',
									                        'id' => 'ifname',
									                        'class' => 'input_box',
									                         'value'        => $item->Name_of_Business, 
									                        'readonly' => 'readonly',
									                        'style' => 'width:450px'
									                    );
			    ...
			    <div class="column">
				    <img style="width: 125px;height: 125px;margin-left: 445px" src="<?php echo base_url(); ?>/Images/nologo.png" alt="Seleccionar Logo" > <br> <br>
				    <input style="margin-left: 430px;width: 150%" type="submit" value="Seleccionar Logo">
			    </div>
