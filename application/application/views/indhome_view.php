...
<div id="wrapper">
	  ...
	  <div class="eventtable">
	    ...
	    <?php
                    echo form_open('Individual/vol_valid'); ?>
	    ...
	    <?php if(isset($popid)){
	    	echo "<script>location.href = '".base_url()."Individual/".$popid."';</script>";
	    }
	    ?>
    ...
    <div id="welcome" class="overlay">
					<div class="popup">
						...
						<label for="fgpsd" style="padding-top:0px; padding-left: 10px;">Gracias por ser un voluntario en nuestros evento.</label><br>
						<hr class="popupline" COLOR="#F0F0F0">
							
						<a href="<?php echo base_url(); ?>/Individual"><input   type="submit" value="Close" style="margin-left: 450px; margin-bottom: 10px;background-color:#A9A9A9" ></a>
					</div>
	</div>
